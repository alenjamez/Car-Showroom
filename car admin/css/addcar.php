...
<body>
    ...
    <div id="page-content-wrapper">
      <br><br><h2><center><b>Car List</b></h3><br><br><br><hr style="border: 1px solid red;">

          <button class="btn btn-primary"  onclick="location.href='add.html'" id="butn">Add Car</button>
